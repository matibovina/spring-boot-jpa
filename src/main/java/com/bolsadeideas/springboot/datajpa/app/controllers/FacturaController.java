...
//	@GetMapping(path = "/load-products", produces = {"application/json"})
//	public ResponseEntity<List<Producto>> loadProducts(String term) {
//	   return ResponseEntity.ok().body(clienteService.findByNombre(term));
//	}
	...
	public String guardar(@Valid Factura factura,
		...
		if(itemId == null || itemId.length == 0) {
			model.addAttribute("titulo", "Crear factura");
			model.addAttribute("error", "Error: Debe incluir al menos 1 item");
			return "factura/form";
		}
