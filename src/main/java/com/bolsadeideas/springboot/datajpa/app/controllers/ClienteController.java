...
public class ClienteController {
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		if (auth != null) {
			// logger.info("Utilizando SecurityContextHolder Hola usuario autenticado, tu
			// username es: ".concat(authentication.getName()));
		}
	...
	public String guardar(@Valid Cliente cliente, BindingResult result, Model model,
		...
		String mensajeFlash = (cliente.getId() != null) ? "Cliente editado con exito!" : "Cliente eliminado con exito!";
	...
	private boolean hasRole(String role) {
		...
		for (GrantedAuthority authority : authorities) {
			if (role.equals(authority.getAuthority())) {
				logger.info("Hola ".concat(auth.getName()).concat("tu rol es: " + auth.getAuthorities()));
